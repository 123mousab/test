        ...
        <div class="row">
            ...
            <div class="col-md-4">
                    ...
                    <input
                        ...
                        name="delegate_name"
                        class="form-control"
                        v-model="addEditObj.delegate_name"
                        :disabled="viewMode"
                    />
...
export default {
            ...
            this.$validator.validateAll("addEditValidation").then((result) => {
                if (result) {
                    ...
                    if(this.addEditObj.id>0){
                        this.$store.dispatch("cities/updateData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
                        ...
                        this.$store.dispatch("cities/saveData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
    ...
    created() {
        ...
        this.$store.dispatch(`cities/findData`, this.idSelected).then(res=>{

<template>
    <form ref="form" @submit.stop.prevent="saveAddEdit">
        ...
        <div class="row">
            <div class="col-md-6">
                <label class="control-label">بداية الوقت</label>
                <input
                    type="time"
                    name="start_date"
                    class="form-control"
            ...
            <div class="col-md-6">
                <label class="control-label">نهاية الوقت</label>
                <input
                    type="time"
                    name="end_date"
                    class="form-control"
...
export default {
            ...
            this.$validator.validateAll("addEditValidation").then((result) => {
                if (result) {
                    ...
                    if (this.addEditObj.id > 0) {
                        this.$store.dispatch("periods/updateData", this.addEditObj)
                            .then(res => {
                                this.$notify.success({
                                    duration: 3000,
                        ...
                        this.$store.dispatch("periods/saveData", this.addEditObj)
                            .then(res => {
                                this.$notify.success({
                                    duration: 3000,
    ...
    created() {
        ...
        this.$store.dispatch(`periods/findData`, this.idSelected).then(res => {

...
export default {
            ...
            this.$validator.validateAll("addEditValidation").then((result) => {
                if (result) {
                    ...
                    if(this.addEditObj.id>0){
                        this.$store.dispatch("companies/updateData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
                        ...
                        this.$store.dispatch("companies/saveData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
    ...
    created() {
        ...
        this.$store.dispatch(`companies/findData`, this.idSelected).then(res=>{

<template>
    ...
    <div class="mt-3">
        ...
        <span>/</span>
        <label active>الشركات</label>
    </div>
        <h4 class="mt-3">الشركات</h4>
        ...
        methods: {
            ...
            deleteRow(idVal){
                this.$confirm(this.$t('DeleteConfirmMessage'), this.$t('DeleteConfirmTitle'), {
                    ...
                    this.$store.dispatch("companies/removeData", idVal)
                    .then(_ => {
            ...
            initData(filters) {
                this.$store
                .dispatch("companies/getData", filters)
                .then(res => {
            ...
            this.$store
                .dispatch("companies/updateStatus", JSON.stringify(sendData))
                .then(() => {
                    this.$notify.success({
                        duration: 3000,

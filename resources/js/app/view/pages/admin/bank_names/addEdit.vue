...
export default {
            ...
            this.$validator.validateAll("addEditValidation").then((result) => {
                if (result) {
                    ...
                    if(this.addEditObj.id>0){
                        this.$store.dispatch("bank_names/updateData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
                        ...
                        this.$store.dispatch("bank_names/saveData", this.addEditObj)
                        .then(res => {
                            this.$notify.success({
                                duration: 3000,
    ...
    created() {
        ...
        this.$store.dispatch(`bank_names/findData`, this.idSelected).then(res=>{
